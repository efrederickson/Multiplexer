...
-(UIView*) headerView
{
    ...
    header.image = [[PDFImage imageWithContentsOfFile:@"/Library/PreferenceBundles/ReachAppSettings.bundle/MissionControlHeader.pdf"] imageWithOptions:[PDFImageOptions optionsWithSize:CGSizeMake(40, 32)]];
